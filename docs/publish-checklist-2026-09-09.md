...
> 3. 결정 반영(9/9): 배송·반품 문구는 "익일 발송·1–3일·무료배송·30일 반품"으로 복원, 창고 그리드·아마존 배지 ON. 외부 편집의 코드 개선은 유지.
...
## 5. 외부 편집분 처리 결과 (2026-09-08 16:18Z) — 결정 완료
...
Alex 결정(9/9)에 따라 "어제 지시" 열의 문구로 복원했고 토글은 모두 ON. 외부 편집이 넣은 코드(품절 변형 시 배송문구 숨김, Loox 평점 메타필드, 비교표 스니펫, 주장 토글)는 그대로 살렸다. 레거시 템플릿 20개도 복원 버전으로 다시 덮어썼고, 의자 25개 프리뷰에서 문구·창고 4곳·Liquid 오류 0 확인.
